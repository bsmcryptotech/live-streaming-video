...
function delete_page($id)
{
	...
	if ( ! $result)
	{
		return array('type' => 'error', 'msg' => 'Could not delete this page. An error occurred:'. mysql_error());
	}
...
function mass_delete_pages($ids)
{
	...
	if (pm_count($ids) > 0)
	{
		...
		if ( ! $result)
		{
			return array('type' => 'error', 'msg' => 'Could not delete these pages. An error occurred: '. mysql_error());
		}
