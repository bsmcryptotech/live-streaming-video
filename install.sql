...
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(1, 'Header', 'Appears on all pages right under the horizontal menu', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(2, 'Footer', 'Appears on all pages right before the footer', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(3, 'Video Player', 'Appears on video pages under the video player. (Recommended max. width: 540px)', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(4, 'Article Page', 'Appears at the end of all articles (Recommended max. width: 540px)', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(5, 'Index page', 'Appears as the first widget block on the right site of your homepage (Recommended max. width: 250px)', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(6, 'Floating Skyscraper (Left)', 'Appears on the left side of the page container', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(7, 'Floating Skyscraper (Right)', 'Appears on the right side of the page container', '', '0', '1', '1');
INSERT INTO `pm_ads` (`id`, `position`, `description`, `code`, `active`, `disable_stats`, `protected`) VALUES(900, 'In-Player Leaderboard ', 'This Leaderboard ad appears over the player. Recommended format: 728 x 90px.', '', '0', '1', '1');
...
INSERT INTO `pm_chart` (`uniq_id`, `views`, `views_this`, `views_last`, `views_seclast`) VALUES('97d7e235d', 1, 1, 0, 0);
INSERT INTO `pm_chart` (`uniq_id`, `views`, `views_this`, `views_last`, `views_seclast`) VALUES('66189809a', 1, 1, 0, 0);
INSERT INTO `pm_chart` (`uniq_id`, `views`, `views_this`, `views_last`, `views_seclast`) VALUES('ac0266df0', 1, 1, 0, 0);
...
INSERT INTO `pm_comments` (`id`, `uniq_id`, `username`, `comment`, `added`, `user_ip`, `user_id`, `approved`, `up_vote_count`, `down_vote_count`, `score`, `report_count`) VALUES(1, 'ac0266df0', 'admin', 'Lovely video site!', 1355843312, '127.0.0.1', 1, '1', 0, 0, 0, 0);
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('player_h_embed', '430');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('template_f', 'apollo');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('version', '3.0');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('total_videos', '3');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('published_videos', '3');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('allow_emojis', '0');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('series_per_page', '21');
INSERT INTO `pm_config` (`name`, `value`) VALUES('featured_genres', 'a:0:{}');
INSERT INTO `pm_config` (`name`, `value`) VALUES('jwplayer8key', '');
INSERT INTO `pm_config` (`name`, `value`) VALUES('oauth_google', '0');
INSERT INTO `pm_config` (`name`, `value`) VALUES('oauth_google_clientid', '');
INSERT INTO `pm_config` (`name`, `value`) VALUES('mod_series', '0');
INSERT INTO `pm_config` (`name`, `value`) VALUES('total_series', '0');
INSERT INTO `pm_config` (`name`, `value`) VALUES('total_episodes', '0');
INSERT INTO `pm_config` (`name`, `value`) VALUES('top_episodes_sort', 'views');
INSERT INTO `pm_config` (`name`, `value`) VALUES('admin_ui_prefs', '{"1":{"import_from":"youtube","videos_pp":25,"pages_pp":25,"articles_pp":25,"cron_jobs_pp":25,"series_pp":50,"episodes_pp":25,"users_pp":25,"comments_pp":25,"":20}}');
...
DROP TABLE IF EXISTS `pm_episodes`;
CREATE TABLE `pm_episodes` (
  ...
  KEY `uniq_id` (`uniq_id`),
  KEY `series_id` (`series_id`,`season_no`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `pm_genres`;
...
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(1, 0, 'action', 'Action', 0, 0, 0, 1, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(2, 0, 'adventure', 'Adventure', 0, 0, 0, 2, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(3, 0, 'biography', 'Biography', 0, 0, 0, 4, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(4, 0, 'comedy', 'Comedy', 0, 0, 0, 5, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(5, 0, 'crime', 'Crime', 0, 0, 0, 6, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(6, 0, 'drama', 'Drama', 0, 0, 0, 7, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(7, 0, 'family', 'Family', 0, 0, 0, 8, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(8, 0, 'fantasy', 'Fantasy', 0, 0, 0, 9, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(9, 0, 'film-noir', 'Film-Noir', 0, 0, 0, 10, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(10, 0, 'history', 'History', 0, 0, 0, 11, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(11, 0, 'horror', 'Horror', 0, 0, 0, 12, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(12, 0, 'music', 'Music', 0, 0, 0, 13, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(13, 0, 'musical', 'Musical', 0, 0, 0, 14, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(14, 0, 'mystery', 'Mystery', 0, 0, 0, 15, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(15, 0, 'romance', 'Romance', 0, 0, 0, 16, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(16, 0, 'sci-fi', 'Sci-Fi', 0, 0, 0, 17, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(17, 0, 'sport', 'Sport', 0, 0, 0, 18, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(18, 0, 'thriller', 'Thriller', 0, 0, 0, 19, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(19, 0, 'war', 'War', 0, 0, 0, 20, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(20, 0, 'western', 'Western', 0, 0, 0, 21, '', '', '');
INSERT INTO `pm_genres` (`id`, `parent_id`, `tag`, `name`, `total_series`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`, `image`) VALUES(21, 0, 'animation', 'Animation', 0, 0, 0, 3, '', '', '');
...
DROP TABLE IF EXISTS `pm_genre_relationships`;
...
INSERT INTO `pm_playlists` (`list_id`, `list_uniq_id`, `user_id`, `type`, `items_count`, `date`, `visibility`, `sorting`, `title`, `description`, `thumb_source`) VALUES (2, '913554463FAF', 1, 2, 0, 1408110639, 1, 'default', '', '', '');
INSERT INTO `pm_playlists` (`list_id`, `list_uniq_id`, `user_id`, `type`, `items_count`, `date`, `visibility`, `sorting`, `title`, `description`, `thumb_source`) VALUES (3, '23BA3BE660A1', 1, 3, 0, 1408110639, 1, 'default', '', '', '');
...
DROP TABLE IF EXISTS `pm_series`;
CREATE TABLE `pm_series` (
  `series_id` mediumint(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`, `vscheck_support`, `vscheck_autopilot`) VALUES (NULL, 'googledrive', '/drive\\.google/i', 'https://drive.google.com/file/d/[VIDEO ID]/view', '0', '1', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="//drive.google.com/file/d/%%yt_id%%/preview" frameborder="0" border="0" marginwidth="0" marginheight="0" scrolling="no" allowfullscreen></iframe>', 'embed', '0', '0'); 
-- --------------------------------------------------------
...
INSERT INTO `pm_tags` (`tag_id`, `uniq_id`, `tag`, `safe_tag`) VALUES(6, '66189809a', 'high', 'high');
INSERT INTO `pm_tags` (`tag_id`, `uniq_id`, `tag`, `safe_tag`) VALUES(7, '66189809a', 'high on life', 'high-on-life');
INSERT INTO `pm_tags` (`tag_id`, `uniq_id`, `tag`, `safe_tag`) VALUES(8, '66189809a', 'martin', 'martin');
INSERT INTO `pm_tags` (`tag_id`, `uniq_id`, `tag`, `safe_tag`) VALUES(9, '66189809a', 'garrix', 'garrix');
...
CREATE TABLE `pm_videos` (
  ...
  PRIMARY KEY (`id`),
  KEY `uniq_id` (`uniq_id`,`video_type`),
  KEY `added` (`added`),
  KEY `yt_id` (`yt_id`),
...
INSERT INTO `pm_videos_urls` (`uniq_id`, `mp4`, `direct`) VALUES('66189809a', '', 'https://www.youtube.com/watch?v=Vbv4hD2jG2g');
INSERT INTO `pm_videos_urls` (`uniq_id`, `mp4`, `direct`) VALUES('97d7e235d', '', 'https://www.youtube.com/watch?v=UcHssjWkQ2M');
INSERT INTO `pm_videos_urls` (`uniq_id`, `mp4`, `direct`) VALUES('d686e93cc', '', 'https://www.youtube.com/watch?v=7ceBrdlzcWk');
