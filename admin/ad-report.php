...
$graph_data_count = pm_count($graph_data);
...
<div class="page-header-wrapper"> 
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<a href="ad-report.php" class="breadcrumb-item active"><?php echo $_page_title; ?></a>
				</div>
	...
	<div class="card">
		...
		<div class="enclosed enclosed-quick-add shadow-div border-radius2">
			...
			<form class="form-inline" name="graph-input-data" method="get" action="ad-report.php">

			<div class="control-group mr-3">
				<div class="float-left d-block">
					<label><strong>From</strong></label>
				</div>
				<div class="control-group">
				<input type="text" id="datepicker_start" name="date_start" value="<?php echo date('m/d/Y', $time_start); ?>" class="datepicker form-control" data-date-format="mm/dd/yyyy" autocomplete="off">
				</div>
			</div>
			<div class="control-group mr-3">
				<div class="float-left d-block">
				...
				<div class="control-group">
				<input type="text" id="datepicker_end" name="date_end" value="<?php echo date('m/d/Y', $time_end); ?>" class="datepicker form-control" data-date-format="mm/dd/yyyy" autocomplete="off">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="control-group">
				<select name="selected-ad" class="custom-select">
					...
					<optgroup label="Classic Ads">
						...
						<?php if (pm_count($current_ads[_AD_TYPE_CLASSIC])) :
					...
					<optgroup label="Pre-roll Static Ads">
						...
						<?php if (pm_count($current_ads[_AD_TYPE_PREROLL])) :
					...
					<optgroup label="Pre-roll Video Ads">
						...
						<?php if (pm_count($current_ads[_AD_TYPE_VIDEO])) :
				...
				<div class="control-group">
					<input type="submit" class="btn btn-success mt-3 ml-3" value="Show" name="submit" />
				</div>
			</form>
			</div>
		</div>
	...
	<?php if ($graph_data_count && pm_count($errors) == 0) : ?>
	<div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title"><?php echo date('D, F j, Y', $time_start) .' &mdash; '. date('D, F j, Y', $time_end); ?></h5>
		</div>
		<div class="card-body">		
		<div class="report-container border-0">
