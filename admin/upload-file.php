...
if ($_POST['doing'] == 'upload_subtitle') // Uploading subtitle form edit-video.php (swfuploader)
{
	$allowed_ext 	= array('.vtt', '.srt');
	$uploadDir 	= _SUBTITLES_DIR_PATH;
}
else if ($_POST['doing'] == 'upload_video') // Uploading media form edit-video.php (swfuploader)
{
			...
			if ($_POST['uniq_id'] != '')
			{
				...
				if (is_array($row))
				{
					...
					foreach ($subtitles as $k => $sub)
					{
						...
						$html .= '<i class="icon-download"></i> <strong><a href="'. _SUBTITLES_DIR . $sub['filename'] .'" title="Download file" target="_blank">Download</a></strong>';
						$html .= '<i class="icon-trash"></i> <strong><a href="" title="Delete subtitle" data-sub-id="'. $sub['id'] .'" onclick="return delete_subtitle('. $sub['id'] .')">Delete</a></strong>';
						$html .= '</span>';
...
//					$html .= '<i class="icon-download"></i> <strong><a href="'. _SUBTITLES_DIR . $new_name .'" title="Download file" target="_blank">Download</a></strong>';
//					$html .= '</span>';
//					$html .= '<strong>'. ucfirst($languages[$_POST['language']]) .'</strong> <span class="badge badge-info">updated</span></li>';
...
//					$html .= '<i class="icon-download"></i> <strong><a href="'. _SUBTITLES_DIR . $new_name .'" title="Download file" target="_blank">Download</a></strong>';
//					$html .= '</span>';
//					$html .= '<strong>'. ucfirst($languages[$_POST['language']]) .' </strong> <span class="badge badge-success">uploaded</span></li>';
