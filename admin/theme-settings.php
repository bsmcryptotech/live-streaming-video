			...
			<?php 
				...
				<li class="theme-item">
					...
					<img src="<?php echo make_url_https($theme['thumb_url']);?>" alt="Theme Image" border="0" class="theme-thumb" />
									...
									<a href="<?php echo $theme['preview_url'];?>" target="_blank" class="btn btn-sm btn-link font-weight-semibold">Preview</a>
									<a href="<?php echo $theme['buy_url'];?>" target="_blank" class="btn btn-sm btn-link font-weight-semibold">Order now</a>
							</li>
				<?php endforeach; ?>
					</ul>
			<?php else : 
