...
{
	case 'deleted':
		$info_msg = pm_alert_success('Selected video(s) were removed.');
	break;
	...
	case 'approve':
		...
		$video_details['video_type'] 	= 	IS_VIDEO;
		...
		else
		{
			...
			$info_msg = pm_alert_success('Video has been approved<br />Would you like to <strong><a href="edit-video.php?vid='.$uniq_id.'">edit</a></strong> it now?'); 
		}
	...
	case 'delvid':
		...
		echo '<meta http-equiv="refresh" content="0;URL=pending-videos.php?a=deleted&page='. $page .'" />';
		exit();
	break;
...
$filename = ('' != $_SERVER['PHP_SELF']) ? basename($_SERVER['PHP_SELF']) : 'pending-videos.php';
$pagination = '';
	...
	<div class="page-header page-header-light">
		...
		<div class="d-flex justify-content-between w-100">
			...
			<div class="header-elements d-flex-inline align-self-center ml-auto">
				<div class="">
					<h5 class="font-weight-semibold mb-0 text-center"><?php echo pm_number_format($total_videos); ?></h5>
					<span class="text-muted font-size-sm">video<?php echo ($total_videos > 1) ? 's' : '';?></span>
				</div>
			</div>
		</div>
		</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<a href="pending-videos.php" class="breadcrumb-item"><span class="breadcrumb-item active"><?php echo $_page_title; ?></span></a>
				</div>
...
<div class="align-middle text-center mt-3 pt-3">
	<i class="icon-stack-play icon-3x text-muted mb-3"></i>
	<h6 class="font-weight-semibold text-grey mb-1">No submitted videos yet</h6>
	<p class="text-grey mb-3 pb-1">Videos suggested or uploaded by users will appear here.</p>
</div>
...
<?php echo $info_msg; ?>
<?php 
if (is_array($errors) && pm_count($errors) > 0)
{
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-6 d-none d-md-block">
			<div class="float-right mb-3">
				<form name="videos_per_page" action="pending-videos.php" method="get" class="form-inline pull-right">
...
<form name="approve_videos_checkboxes" action="pending-videos.php?page=<?php echo $page;?>" method="post">
<div class="datatable-scroll">
<table cellpadding="0" cellspacing="0" width="100%" class="table table-md table-striped table-columned pm-tables tablesorter">
<thead>
<tr> 
	<th align="center" class="text-center" width="20"><input type="checkbox" class="checkbox" name="checkall" id="selectall" onclick="checkUncheckAll(this);"/></th>
	<th width="15">&nbsp;</th>
		...
		<div class="float-right">
			...
			<div class="btn-group btn-group-sm dropup">
				...
				<div class="dropdown-menu border-warning border-2 text-warning">
					<li><a href="#" rel="tooltip" title="Remove ALL (<?php echo $total_videos; ?>) pending videos?" class="dropdown-item font-weight-bold" onClick="del_alltemp()">Delete all</a></li>			
				</div>
			</div>
		</div>
